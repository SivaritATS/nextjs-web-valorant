...
export default function NewsDetail({ params }) {
  ...
  if (!news)
    return (
      <p className="flex items-center justify-center min-h-screen bg-gray-100 p-4 text-5xl">
        ไม่พบหน้าข่าวสารที่คุณต้องการ!!
        <br></br>
        <svg
          width="800px"
          height="800px"
  ...
  return (
    <div className="p-5 flex flex-col items-center justify-center text-center ">
      ...
      <img
        src={news.img}
        alt={news.title}
        className="max-w-[60%] h-auto rounded-lg mt-4"
      />
      <p className="mt-4 text-lg leading-relaxed whitespace-pre-line text-left max-w-4xl text-white">
        {news.description}
      </p>
